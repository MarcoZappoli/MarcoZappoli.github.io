...
<div class="project-body">
  ...
  <h4>⚠️ Note</h4>
  <p>
    The technical reports are currently available in <b>Italian</b>, as required by the original coursework. 
    An <b>English version</b> may be provided in the future.
  </p>
</div>

  <hr>

  <h1>Lab 1 &ndash; Force Measurements 📊</h1>
  ...
  <h1>Lab 2 &ndash; Pressure Measurements & Hot-Wire Anemometry 🌡️</h1>
  ...
  <figure class="zoomable">
    ...
    <div style="display: flex; justify-content: center;">
      <img src="/images/FFT 110.png" alt="FFT scia" style="width: 90%; border-radius: 4px;">
    </div>
  ...
  <h1>Lab 3 &ndash; Particle Image Velocimetry (PIV) 🌀</h1> 
